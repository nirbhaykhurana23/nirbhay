...
public class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
    ...
    public void configure(final HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/add-to-cart/{customer_id}/{productVariation_id}").hasAnyRole("CUSTOMER")
                .antMatchers("/order/{customer_user_id}/{cart_id}").hasAnyRole("CUSTOMER")
                .antMatchers("/forgot-password").permitAll()
                .antMatchers("/reset-password").permitAll()
                .antMatchers("/account-unlock/{username}").permitAll()
                .antMatchers("/do-unlock").permitAll()
                .antMatchers("add-review/{customer_user_id}/{product_id}").hasAnyRole("CUSTOMER")
